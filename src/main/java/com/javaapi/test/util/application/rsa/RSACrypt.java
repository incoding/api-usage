...
public class RSACrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String merchantId = "";
        String originData = policyId + "_" + merchantId + "_" + now;
        String publicKey = "";
        String encryptData = RSACrypt.encrypt(RSACrypt.loadPublicKey(publicKey), originData.getBytes());
        System.out.println("code = " + URLEncoder.encode(encryptData, "utf-8"));

        String secret = "";
        String privateKey = "";
        String decryptData = RSACrypt.decrypt(RSACrypt.loadPrivateKey(privateKey), RSACrypt.strToBase64(secret));
