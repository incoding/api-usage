...
public class Client2 {
    public static void main(String[] args) throws BeansException {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("com/javaapi/test/spring/zotherFeature/scheduler/quartz2/spring/applicationContext.xml");        QuartzManager quartzManager = (QuartzManager) ctx.getBean("quartzManager");
        try {
