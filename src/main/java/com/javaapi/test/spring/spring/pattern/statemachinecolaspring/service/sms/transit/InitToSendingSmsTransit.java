 ...
 * @see SmsState
 */
@Transit(machine = StateMachineConfigEnum.SMS, from = "INIT", to = "SENDING", event = "SEND")
@Component
@Slf4j
public class InitToSendingSmsTransit implements IStateTransit<SmsState, SmsEvent, SmsContext, SmsResult> {
