 ...
 * @see SmsState
 */
@Transit(machine = StateMachineConfigEnum.SMS, from = "SENDING", to = "SUCCESS", event = "SEND_SUCCESS")
@Component
@Slf4j
public class SendingToSuccessSmsTransit implements IStateTransit<SmsState, SmsEvent, SmsContext, SmsResult> {
