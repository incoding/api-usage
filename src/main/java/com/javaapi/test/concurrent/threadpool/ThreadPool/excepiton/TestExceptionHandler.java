...
import com.javaapi.test.concurrent.thread.thread.exception.exception2ThreadUncaughtExceptionHandler.Client;
 ...
 * 1. 在提交的任务中将异常捕获并处理，不抛给线程池。
 ...
 @see com.javaapi.test.concurrent.thread.thread.exception.exception2ThreadUncaughtExceptionHandler.Client
 */
public class TestExceptionHandler {
    private com.javaapi.test.concurrent.thread.thread.exception.exception2ThreadUncaughtExceptionHandler.Client client = new Client();
