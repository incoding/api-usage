 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server.webservice.rpc.application.test.javaapi.com/", wsdlLocation = "http://localhost:8989/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://server.webservice.rpc.application.test.javaapi.com/", "HelloWorldImplService");
    ...
    public HelloWorldImpl getHelloWorldImplPort() {
        return super.getPort(new QName("http://server.webservice.rpc.application.test.javaapi.com/", "HelloWorldImplPort"), HelloWorldImpl.class);
    }
    ...
    public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.rpc.application.test.javaapi.com/", "HelloWorldImplPort"), HelloWorldImpl.class, features);
    }
