...
public class TestDiffLog {
    ...
    public void testDiff() {
        Javers javers = JaversBuilder.javers()
                                     ...
                                     .build();
        PledgeLogDO pledgeOld = new PledgeLogDO("1", "2", "xx");
        PledgeLogDO pledgeNew = new PledgeLogDO(null, "3", "yy");
        Diff compare = javers.compare(pledgeOld, pledgeNew);
        System.out.println("compare.prettyPrint() = " + compare.prettyPrint());
        System.out.println("compare.prettyPrint() = " + compare.toString());
//        new PrettyPrintBuilder();
        compare.getChanges(change -> {
            ...
            ValueChange valueChange = (ValueChange) change;
            valueChange.prettyPrint(PrettyValuePrinter.getDefault()
            );
            System.out.println("valueChange.toString() = " + valueChange.toString());
        });
